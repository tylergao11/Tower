...
export function sampleArt(manifest:{objects:Record<string,ArtObject>;sprites:Record<string,{joints?:Record<string,[number,number]>}>},id:string,action:string,phase:number,options?:{hiddenSlots?:string[]}):ArtPose;
